...
<div class="w3-panel w3-opacity" style="padding:10px 16px">
  <h1 class="w3-xlarge w3-center">Form Anggota</h1>

    <form action="add_data_anggota1.php" method="POST">
      ...
      <button class="w3-button w3-teal"><a href="anggota1.php">Kembali</a></button>
    </form>
</div>
</div>
</body>
