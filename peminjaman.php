...
<div class="w3-panel w3-center w3-opacity" style="padding:10px 16px">
  <h1 class="w3-xlarge">Data Peminjaman</h1>
  
  <div class="w3-padding-32">
    <div class="w3-bar w3-border">
      <a href="home.php" class="w3-bar-item w3-button">HOME</a>
      <a href="add_pinjam.php" class="w3-bar-item w3-button">Tambah</a>
        ...
        <?php
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                <button class="w3-button w3-teal"><a href="edit_data_pinjam.php?id=<?php echo $data['id']?>">Update</a></button>
                                <button class="w3-button w3-teal"><a href="delete_data_pinjam.php?id=<?php echo $data['id']?>">Delete</a></button>
                                </td>
                            </tr>
                        <?php
                        endforeach ?>
