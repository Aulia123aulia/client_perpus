...
<div class="w3-sidebar w3-light-grey w3-bar-block" style="width:25%">
  ...
  <div class="w3-dropdown-hover">
    ...
    <div class="w3-dropdown-content w3-bar-block">
      ...
      <a href="peminjaman.php" class="w3-bar-item w3-button">Data Peminjman</a>
    </div>
  </div>
</div>
...
<div class="w3-panel w3-opacity" style="padding:10px 16px">
  <h1 class="w3-xlarge w3-center">Form Data Peminjman</h1>

    <form action="add_data_pinjam.php" method="POST">
      ...
      <div class="w3-section">
        ...
        <input class="w3-input w3-border" type="text" name="tanggalpinjam" required>
      </div>
      <div class="w3-section">
        <label>Tanggal Kembali</label>
        <input class="w3-input w3-border" type="text" name="tanggalkembali" required>
      </div>
      <div class="w3-section">
        <label>Status</label>
        <input class="w3-input w3-border" type="text" name="status" required>
      </div>
